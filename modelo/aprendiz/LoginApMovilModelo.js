...
class LoginApMovilModelo {
     ...
     * @param {string} [data.dispositivo="Web"] - El tipo de dispositivo (por defecto "movil").
     * @throws {Error} Si ocurre un error al guardar el token.
     */
    static async guardarTokenSesion({ documento, nombresAprendiz, token, dispositivo = "Movil" }) {
     ...
     * @param {string} [dispositivo="Web"] El tipo de dispositivo (por defecto "Movil").
     * @returns {Object|null} El token encontrado o null.
     * @throws {Error} Si ocurre un error en la base de datos.
     */
    static async buscarTokenSesionActiva(documento, dispositivo = "Movil") {
...
module.exports = LoginApMovilModelo;