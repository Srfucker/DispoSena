...
class LoginInstructorWebModelo {
    constructor() {
        if (LoginInstructorWebModelo.instance) {
            return LoginInstructorWebModelo.instance;
        }
        LoginInstructorWebModelo.instance = this;
    }
...
module.exports = new LoginInstructorWebModelo();