...
class LoginAdminEduModelo {
    constructor() {
        if (LoginAdminEduModelo.instance) {
            return LoginAdminEduModelo.instance;
        }
        LoginAdminEduModelo.instance = this;
    }
...
module.exports = new LoginAdminEduModelo();