...
class LoginVigilanteModelo {
    constructor() {
        if (LoginVigilanteModelo.instance) {
            return LoginVigilanteModelo.instance;
        }
        LoginVigilanteModelo.instance = this;
    }
...
module.exports = new LoginVigilanteModelo();