...
class LoginTicMovilModelo {
  constructor() {
    if (LoginTicMovilModelo.instance) {
      return LoginTicMovilModelo.instance;
    }
    LoginTicMovilModelo.instance = this;
  }
...
module.exports = new LoginTicMovilModelo();