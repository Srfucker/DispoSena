...
const modelo = require('../../modelo/vigilantes/LoginVigilanteWebModelo');

class LoginVigilanteWebControlador {
    constructor() {
        if (LoginVigilanteWebControlador.instance) {
            return LoginVigilanteWebControlador.instance;
        }
        LoginVigilanteWebControlador.instance = this;
    }
...
module.exports = new LoginVigilanteWebControlador();