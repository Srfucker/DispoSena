...
const modelo = require('../../modelo/vigilantes/LoginVigilanteModelo');

class LoginVigilanteControlador {
    constructor() {
        if (LoginVigilanteControlador.instance) {
            return LoginVigilanteControlador.instance;
        }
        LoginVigilanteControlador.instance = this;
    }
...
module.exports = new LoginVigilanteControlador();