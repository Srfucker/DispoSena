...
const modelo = require('../../modelo/instructor/LoginInstructorWebModelo');

class LoginInstructorWebControlador {
    constructor() {
        if (LoginInstructorWebControlador.instance) {
            return LoginInstructorWebControlador.instance;
        }
        LoginInstructorWebControlador.instance = this;
    }
...
module.exports = new LoginInstructorWebControlador();