...
const modelo = require('../../modelo/instructor/LoginInstructorModelo');

class LoginInstructorControlador {
    constructor() {
        if (LoginInstructorControlador.instance) {
            return LoginInstructorControlador.instance;
        }
        LoginInstructorControlador.instance = this;
    }
...
module.exports = new LoginInstructorControlador();