...
const modelo = require('../../modelo/tic/LoginTicWebModelo');

class LoginticWebControlador {
    constructor() {
        if (LoginticWebControlador.instance) {
            return LoginticWebControlador.instance;
        }
        LoginticWebControlador.instance = this;
    }
    ...
    async validarCredencial(req, res) {
        ...
        try {
            ...
            if (sesionActiva) {
                return res.status(401).json({ error: 'Ya existe una sesión activa para este usuario en un dispositivo Web. Cierre la sesión existente.' });
            }
...
module.exports = new LoginticWebControlador();