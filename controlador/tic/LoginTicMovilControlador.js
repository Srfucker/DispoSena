...
const modelo = require('../../modelo/tic/LoginTicMovilModelo');

class LoginticMovilControlador {
    constructor() {
        if (LoginticMovilControlador.instance) {
            return LoginticMovilControlador.instance;
        }
        LoginticMovilControlador.instance = this;
    }
...
module.exports = new LoginticMovilControlador();