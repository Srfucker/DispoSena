...
const modelo = require('../../modelo/admineducativa/LoginAdminEduModelo');

class LoginAdminEduControlador {
    constructor() {
        if (LoginAdminEduControlador.instance) {
            return LoginAdminEduControlador.instance;
        }
        LoginAdminEduControlador.instance = this;
    }
...
module.exports = new LoginAdminEduControlador();