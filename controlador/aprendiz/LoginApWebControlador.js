...
const modelo = require('../../modelo/aprendiz/LoginApWebModelo');

class LoginApWebControlador {
    static async validarCredencial(req, res) {
        ...
        try {
            ...
            if (sesionActiva) {
                return res.status(401).json({ error: 'Ya existe una sesión activa para este usuario en un dispositivo web. Cierre la sesión existente o use otro navegador.' });
            }
            ...
            await modelo.guardarTokenSesion({
                ...
                token: token,
                dispositivo: "Web" // Hardcodeado para este modelo/controlador web
            });
...
module.exports = LoginApWebControlador;